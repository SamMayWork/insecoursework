...
insert into Posts (post_id, keyword_id, post_title, post_content, post_likes, user_id, created_date, edited_date) VALUES ('11f3b99f','986fcdbe', 'stems till wore stretch','exclaimed scene ice game also closer became law damage hold mail hour care give definition spread bent step walk modern mad whole beautiful your tank sense cold picture listen hunt phrase construction grade direction shaking fastened summer chair purpose birds herd safety discover toward folks nature talk truck',10                                                    ,'acc45ba4','2020-02-02','2020-02-06');
...
insert into Posts (post_id, keyword_id, post_title, post_content, post_likes, user_id, created_date, edited_date) VALUES ('d0e039b3','412fb90d', 'like as new hello','plastic vast opinion position screenclimate treated alphabet bound many title becoming cool try oldest port own still thank worth being card close western nature make everybody tool including energy learn baseball clothes scientist until mud continued coast war tent powder worry lady breakfast wheel alike wealth ice cotton already nervous kill combine',95                 ,'966abbd2','2020-02-22','2020-02-28');
